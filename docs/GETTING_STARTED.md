...
For internet access, use the personal **Private-Setup** installer on each PC. It configures the relay automatically; follow [internet support](INTERNET.md) to connect. The local-network setup below remains available separately.
