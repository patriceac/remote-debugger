...
internal sealed class ViewerComboBox : LocalizedComboBox
{
    ...
    protected override void OnPaint(Forms.PaintEventArgs e)
    {
        ...
        using var fill = new SolidBrush(Color.FromArgb(253, 253, 254));
        using var pen = new Pen(Focused ? Color.FromArgb(0, 99, 255) : Color.FromArgb(195, 200, 205), scale);
        ...
        using var arrow = new Pen(Color.FromArgb(106, 115, 124), scale);
...
internal sealed class ViewerCheckBox : Forms.CheckBox
{
    ...
    protected override void OnPaint(Forms.PaintEventArgs e)
    {
        ...
        using var fill = new SolidBrush(Checked ? Color.FromArgb(0, 99, 255) : Color.FromArgb(250, 251, 252));
        using var border = new Pen(Checked ? Color.FromArgb(0, 99, 255) : Color.FromArgb(153, 158, 165), scale);
