param(
    [ValidateSet('Both', 'Agent', 'Controller', 'Input', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance')]
    [string]$Role = 'Both',
...
if ($Role -in @('Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance') -and ($Scope -ne 'Runtime' -or $UpdateVariant -ne 'None')) { throw 'Loopback roles require Runtime scope and None update variant.' }
...
function New-RoleRequest([string]$roleName) {
    ...
    if ($roleName -in @('Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance')) {
    ...
    if ($roleName -notin @('Local', 'Input', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance')) {
