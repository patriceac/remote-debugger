param(
    [ValidateSet('Both', 'Agent', 'Controller', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'SingleInstance')]
    [string]$Role = 'Both',
...
if ($Role -in @('Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'SingleInstance') -and ($Scope -ne 'Runtime' -or $UpdateVariant -ne 'None')) { throw 'Loopback roles require Runtime scope and None update variant.' }
...
function New-RoleRequest([string]$roleName) {
    ...
    if ($roleName -in @('Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'SingleInstance')) {
    ...
    if ($roleName -notin @('Local', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'SingleInstance')) {
