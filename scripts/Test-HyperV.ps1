param(
    [ValidateSet('Both', 'Agent', 'Controller', 'Input', 'Loopback', 'LoopbackEconomy', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'LoopbackWan', 'LoopbackWake', 'LoopbackVersions', 'LoopbackTransport', 'LoopbackNavigation', 'Localization', 'LanguageSelection', 'SingleInstance')]
    [string]$Role = 'Both',
...
function New-RoleRequest([string]$roleName) {
    ...
    if ($roleName -in @('Loopback', 'LoopbackEconomy', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'LoopbackWan', 'LoopbackWake', 'LoopbackVersions', 'LoopbackTransport', 'LoopbackNavigation', 'Localization', 'LanguageSelection', 'SingleInstance')) {
