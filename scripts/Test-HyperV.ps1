param(
    [ValidateSet('Both', 'Agent', 'Controller', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance')]
    [string]$Role = 'Both',
...
function New-RoleRequest([string]$roleName) {
    ...
    if ($roleName -notin @('Local', 'Loopback', 'LoopbackTray', 'LoopbackLifetime', 'LoopbackUi', 'LoopbackExit', 'LoopbackScale', 'LoopbackColumns', 'Localization', 'LanguageSelection', 'SingleInstance')) {
